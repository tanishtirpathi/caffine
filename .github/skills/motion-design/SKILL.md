...
.gradient-bg-3 {
  background:
    ...
    radial-gradient(at 0% 100%, rgba(5, 255, 161, 0.4) 0, transparent 50%), #1a0033;
}
...
<div class="hero textured-bg gradient-bg-1">
  <h1
    class="fade-in stagger-1"
    style="font-family: var(--font-display); font-weight: var(--weight-black);"
  >
    Bold Headline
  </h1>
  <p
    class="fade-in stagger-2"
    style="font-family: var(--font-body); font-weight: var(--weight-light);"
  >
    Supporting text with extreme weight contrast
  </p>
  <button class="fade-in stagger-3 cta-button">Call to Action</button>
</div>
```
...
<html lang="en">
  <head>
    ...
    <!-- Distinctive fonts -->
    <link
      href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;700;900&family=Inter:wght@200;500&display=swap"
      rel="stylesheet"
    />
